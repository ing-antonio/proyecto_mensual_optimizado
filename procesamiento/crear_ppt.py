...
p = Path(current_directory).parents[0]
plantilla_directory = p/"auxiliares/Plantilla1.pptx"
titulos_tarjetas_directory = p/"auxiliares/titulos_tarjetas.csv"
salidas_directory = p/"salidas"

# Asegúrate de usar español para nombres de meses
locale.setlocale(locale.LC_TIME, "es_MX.UTF-8")

### CUANDO SE EJECUTA DENTRO DE LOS PRIMEROS DIAS DEL MES EN CURSO, CON LA FINALIDAD DE
### OBTENER LA EVALUACION DE LOS DOS MESES ANTERIORES
### SE UTILIZA:
### ultimo_mes = hoy.month - 0
### EN LUGAR DE:
...
presentacion_mensual_directory = p/f"salidas/{anio_actual}{mes_actual}{ahora}_reporte_mensual.pptx"
...
df_titulos = pd.read_csv(str(titulos_tarjetas_directory))
...
mapeo = {
    ...
    23: ["robo_espacio_publico.png", "VarAcum_2019T_RPEP.png", "VarAcum_2024T_RPEP.png"],
    24: ["mapa_interactivo_homicidio_lesiones.png"]
}
...
titulos_por_slide = {
    ...
    23: "REP"  # ← diapo de gráfica para Robo espacio publico
}
...
# ───────────────────────────────────────────────
for i in [1, 2, 3, 8, 23, 24]:  # índices de las diapos
    slide = prs.slides[i]
